...
def prewit_filter(image, kernel_size, verbose=False):
    kernel_horizontal, kernel_vertical = prewit_kernel(kernel_size)
...
if __name__ == '__main__':
    ...
    _, plt = prewit_filter(image, 9, verbose=True)
    plt.show()
